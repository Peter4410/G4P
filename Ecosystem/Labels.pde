class Labels {
  ...
  Labels() {
    ...
    labs[0][0] = new Label(50, 50, w1, h1, "add 1 sheep", green);
    labs[0][1] = new Label(50, 50+1*(h1+rG), w1, h1, "add 10 sheep", green);
    labs[0][2] = new Label(50, 50+2*(h1+rG), w1, h1, "add 100 sheep", green);
    labs[0][3] = new Label(50, 50+3*(h1+rG), w1, h1, "add 1000 sheep", green);
    labs[0][4] = new Label(50, 50+4*(h1+rG), w1, h1, "remove 1 sheep", red);
    labs[0][5] = new Label(50, 50+5*(h1+rG), w1, h1, "remove 10 sheep", red);
    labs[0][6] = new Label(50, 50+6*(h1+rG), w1, h1, "remove 100 sheep", red);
    labs[0][7] = new Label(50, 50+7*(h1+rG), w1, h1, "remove 1000 sheep", red);

    labs[1][0] = new Label(50+w1+cG, 50, w1, h1, "add 1 wolf", green);
    labs[1][1] = new Label(50+w1+cG, 50+1*(h1+rG), w1, h1, "add 10 wolves", green);
    labs[1][2] = new Label(50+w1+cG, 50+2*(h1+rG), w1, h1, "add 100 wolves", green);
    labs[1][3] = new Label(50+w1+cG, 50+3*(h1+rG), w1, h1, "add 1000 wolves", green);
    ...
    labs[1][7] = new Label(50+w1+cG, 50+7*(h1+rG), w1, h1, "remove 1000 wolves", red);
